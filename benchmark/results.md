...
| RandomForest (sklearn) | 0.91 | 0.9561 | 0.0123 | 0.9884 | 0.0083 |
| AdaBoost (sklearn) | 1.49 | 0.9561 | 0.0124 | 0.9887 | 0.0075 |
...
| Model | Fit time (s) | Accuracy (mean) | Accuracy (std) | ROC-AUC (mean) | ROC-AUC (std) |
| --- | --- | --- | --- | --- | --- |
| DeepGBoost | 0.67 | 0.96 | 0.0389 | nan | nan |
| GradientBoosting (sklearn) | 0.94 | 0.9533 | 0.034 | 0.9927 | 0.008 |
| RandomForest (sklearn) | 0.61 | 0.9467 | 0.0267 | 0.994 | 0.008 |
| AdaBoost (sklearn) | 0.76 | 0.96 | 0.0389 | 0.9923 | 0.0066 |
